...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <img src="https://raw.githubusercontent.com/RTuioi/MoeKoeMusic-audio-effect-plugin/9d7cb2e674680f6c332ee5d8ab7fcb37dffb838d/icon-48.png" alt="在线音效插件" width="64" height="64"> | audio-effect-plugin | 在线音效插件 | 为播放器添加在线音效功能-音效- \|钢琴 \| 乐器 \| 尤克里里 \| 唢呐 \| DJ \| 伴奏 \| - 其他设置-高潮模式（只播放原曲高潮部分） | 1.0.0 | 🟢 | RTuioi | [下载](https://github.com/RTuioi/MoeKoeMusic-audio-effect-plugin/tree/9d7cb2e674680f6c332ee5d8ab7fcb37dffb838d) |
