...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <img src="https://raw.githubusercontent.com/RTuioi/MoeKoe-EQ-Plugin/7eb8cfb6e5620a71e3104b6d7ae2a03263cf6dd3/icons/icon16.png" alt="MoeKoe EQ - 31段均衡器音效插件" width="64" height="64"> | moekoe-equalizer | MoeKoe EQ - 31段均衡器音效插件 | MoeKoe EQ - 31 段参数  均衡器  扩展插件，提供 EQ 调节、音效增强 等功能，内置多种预设，有效提升听感体验 | 2.0.2 | 🟢 | RTuioi | [下载](https://github.com/RTuioi/MoeKoe-EQ-Plugin/tree/7eb8cfb6e5620a71e3104b6d7ae2a03263cf6dd3) |
