...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <img src="https://raw.githubusercontent.com/Yngu196/TaskbarLyrics/v0.3.7/public/icons/icon256.png" alt="Windows任务栏歌词插件" width="64" height="64"> | Taskbar-Lyrics | Windows任务栏歌词插件 | 为Windows端播放器提供任务栏（状态栏）歌词功能，可暂停或播放下一首/上一首 | 0.3.7 | 🟢 | Yngu196 | [下载](https://github.com/Yngu196/TaskbarLyrics/releases/download/v0.3.7/moeKoe-taskbar-lyrics.zip) |
