...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <img src="https://raw.githubusercontent.com/RTuioi/MoeKoeMusic-audio-effect-plugin/2b20157ac4661a9a8aff9d6358551425e92cbe66/icon-48.png" alt="在线音效插件" width="64" height="64"> | audio-effect-plugin | 在线音效插件 | 为播放器添加在线音效功能-音效- \|钢琴 \| 乐器 \| 尤克里里 \| 唢呐 \| DJ \| 伴奏 \| - 其他设置-高潮模式（只播放原曲高潮部分） | 1.0.1 | 🟢 | RTuioi | [下载](https://github.com/RTuioi/MoeKoeMusic-audio-effect-plugin/tree/2b20157ac4661a9a8aff9d6358551425e92cbe66) |
...
| <img src="https://raw.githubusercontent.com/LateDreamXD/moekoe-blue_archive-theme/v0.2.0/public/assets/icon.png" alt="蔚蓝档案主题" width="64" height="64"> | blue_archive-theme | 蔚蓝档案主题 | 修改了 MoeKoe Music 的外观，并提供了可配置选项 | 0.2.0 | 🟢 | LateDreamXD | [下载](https://github.com/LateDreamXD/moekoe-blue_archive-theme/releases/download/v0.2.0/ba-theme-v0.2.0.zip) |
