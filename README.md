...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <img src="https://raw.githubusercontent.com/Yngu196/TaskbarLyrics/v0.3.1/public/icons/icon16.png" alt="MoeKoeTaskbarLyrics" width="64" height="64"> | Taskbar-Lyrics | MoeKoeTaskbarLyrics | 为Windows端播放器提供任务栏（状态栏）歌词，位置可拖动，可播放下一首/上一首或暂停。<br><br><img width="826" height="50" alt="Image" src="https://github.com/user-attachments/assets/1673b88b-8225-4b03-a0e0-4cc49059538d" /><br><br><img width="835" height="47" alt="Image" src="https://github.com/user-attachments/assets/f4fe3ebf-5de6-4284-b11d-a90c609a22d6" /> | 0.3.1 | 🟢 | Yngu196 | [下载](https://github.com/Yngu196/TaskbarLyrics/releases/download/v0.3.1/moeKoe-taskbar-lyrics.zip) |
